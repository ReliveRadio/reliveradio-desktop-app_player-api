	...
	$.extend(MediaElementPlayer.prototype, {
		buildplaypause: function(player, controls, layers, media) {
			var 
				t = this,
				play = 
				$('<div class="mejs-button mejs-playpause-button icon-mejs-play" >' +
			...
			media.addEventListener('play',function() {
				play.removeClass('icon-mejs-play').addClass('icon-mejs-pause');
			}, false);
			media.addEventListener('playing',function() {
				play.removeClass('icon-mejs-play').addClass('icon-mejs-pause');
			}, false);
			...
			media.addEventListener('pause',function() {
				play.removeClass('icon-mejs-pause').addClass('icon-mejs-play');
			}, false);
...
(function($) {
	...
	$.extend(MediaElementPlayer.prototype, {
		buildstop: function(player, controls, layers, media) {
			var t = this,
				stop = 
				$('<div class="icon-play-circled mejs-button mejs-stop-button mejs-stop">' +
